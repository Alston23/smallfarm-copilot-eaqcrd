        ...
        <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
          <View style={[styles.placeholderCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            <IconSymbol
              ...
              android_material_icon_name="timeline"
              size={64}
              color={farmGreen}
            />
            ...
            <Text style={[styles.placeholderDescription, { color: colors.icon }]}>
              Project future cash flow based on historical data and planned activities. Plan ahead to ensure you have sufficient cash for upcoming expenses.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
