        ...
        <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
          <View style={[styles.placeholderCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            <Text style={[styles.placeholderDescription, { color: colors.icon }]}>
              Track expenses for seeds, fertilizer, soil amendments, and other farming inputs. Add input expenses to your financial transactions with categories like "Seeds", "Fertilizer", or "Soil" to populate this report.
            </Text>
          </View>
        </ScrollView>
      </SafeAreaView>
